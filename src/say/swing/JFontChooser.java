...
public class JFontChooser extends JComponent
{
	...
	protected String val(String key)
	{
		String value = key;
		try
		{
	...
	public JList<String> getFontFamilyList()
	{
		if (fontNameList == null)
		{
			...
			fontNameList.addListSelectionListener(new ListSelectionHandler(fontNameList,getFontFamilyTextField()));
	...
	public JList<String> getFontStyleList()
	{
		if (fontStyleList == null)
		{
			...
			fontStyleList.addListSelectionListener(new ListSelectionHandler(fontNameList,getFontStyleTextField()));
	...
	public JList<String> getFontSizeList()
	{
		if (fontSizeList == null)
		{
			...
			fontSizeList.addListSelectionListener(new ListSelectionHandler(fontNameList,getFontSizeTextField()));
    ...
    private JList<String> list;
		...
		ListSelectionHandler(JList<String> list, JTextComponent textComponent)
		{
      this.list = list;
	...
	protected class DialogOKAction extends AbstractAction
	{
		...
		protected DialogOKAction(JDialog dialog)
		{
			...
			putValue(Action.NAME, val(ACTION_NAME));
		}
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, val("SelectFont"), true);
	...
	protected JPanel getFontFamilyPanel()
	{
		if (fontNamePanel == null)
		{
			...
			JLabel label = new JLabel(val("FontName"));
	...
	protected JPanel getFontStylePanel()
	{
		if (fontStylePanel == null)
		{
			...
			JLabel label = new JLabel(val("FontStyle"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getFontSizePanel()
	{
		if (fontSizePanel == null)
		{
			...
			JLabel label = new JLabel(val("FontSize"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getSamplePanel()
	{
		if (samplePanel == null)
		{
			Border titledBorder = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), val("Sample"));
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField(val("SampleString"));
	...
	protected String[] getFontStyleNames()
	{
		if (fontStyleNames == null)
		{
			...
			fontStyleNames[i++] = val("Plain");
			fontStyleNames[i++] = val("Bold");
			fontStyleNames[i++] = val("Italic");
			fontStyleNames[i++] = val("BoldItalic");
		}
