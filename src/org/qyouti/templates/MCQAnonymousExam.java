 ...
 * @author jon
 */
public class MCQAnonymousExam
        extends ExamTemplate
{
  public String getTemplateTitle() {return "Multiple choice, question and answer paper combined.";}
...
"    </item>\n\n";
  ...
  private void initComponents()
  {
    ...
    scrollpane1.setPreferredSize(new java.awt.Dimension(243, 130));

    descriptiontextarea.setEditable(false);
    descriptiontextarea.setColumns(20);
    descriptiontextarea.setLineWrap(true);
    descriptiontextarea.setRows(5);
    descriptiontextarea.setText("This template produces question papers which incorporate answer boxes into the question text. The questions are pure multiple choice. Anonymous papers are printed without respondent ID or name but provide boxes for the respondent to enter them. Anonymous papers can be used as spares or can be used for all respondents. ");
    ...
    candidateslabel.setText("Number of Anonymous Papers:");
    gridBagConstraints = new java.awt.GridBagConstraints();
