 ...
 * @author jon
 */
public class ImportCandidateDialog
        extends javax.swing.JDialog
{
   ...
   */
  public ImportCandidateDialog( java.awt.Frame parent, boolean modal )
  {
    super( parent, modal );
    initComponents();
  ...
  public ArrayList<CandidateData> getCandidateList()
  {
    return list;
  }
  ...
  {//GEN-HEADEREND:event_importbuttonActionPerformed
    ...
    for ( i = 0; i < rows; i++ )
    {
      ...
      cd = new CandidateData( exam, name, paster.getValueAt( i, d-1 ).toString(), false );
      list.add( cd );
    }
    ...
    for ( i = 0; i < list.size(); i++ )
    {
      ...
      {
        othercd = list.get( j );
        if ( cd.id != null && cd.id.equals( othercd.id ) )
        {
          errorrows[i] = true;
          errorrows[j] = true;
        }
      ...
      if ( exam != null )
      {
        othercd = exam.candidates.get( cd.id );
        if ( othercd != null )
          errorrows[i] = true;
      }
    }
  ...
  public static void main( String args[] )
  {
    ...
    catch ( ClassNotFoundException ex )
    {
      java.util.logging.Logger.
              getLogger( ImportCandidateDialog.class.getName() ).
    ...
    java.awt.EventQueue.invokeLater( new Runnable()
    {
      public void run()
      {
        ImportCandidateDialog dialog = new ImportCandidateDialog( new javax.swing.JFrame(), true );
